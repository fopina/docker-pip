...
RUN useradd pip -m -u 61781 -g 100 && \
	tar xpf pip.tar && rm pip.tar && \
	dpkg --add-architecture i386 && \
	apt-get update && \
	apt-get -y install --no-install-recommends libc6:i386 libncurses5:i386 libstdc++6:i386 vim-tiny wget ca-certificates && \
	...
	rm -fr /home/pip/.fis-gtm && \
	rm /home/pip/gtm_*.err && \
	rm /home/pip/pip_V02/*.mje && \
	rm /home/pip/pip_V02/PROFILE_ERROR.* && \
